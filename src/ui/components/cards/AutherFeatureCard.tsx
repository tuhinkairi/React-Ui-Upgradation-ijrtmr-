...
export default function AuthorFeatureCard({ logo ,icon, title }: {logo?:React.ReactNode, icon: string, title: string, description: string }) {
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm hover:shadow-md transition  max-w-[300px] xl:max-w-90 2xl:max-w-[600px] justify-around h-full hover:bg-[#d6d0fa]">
