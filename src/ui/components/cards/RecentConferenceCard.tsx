  ...
  return (
    <div className="max-w-md mx-auto bg-white rounded-2xl shadow-[0px_0px_40px_5px_rgba(0,0,0,0.08)] p-6">
      ...
      <div className="text-sm 2xl:text-base  text-gray-800 space-y-1">
        <p className="font-semibold">ICISDG’23</p>
        <p className='text-paragraph'>International conference on Innovation towards Sustainable Development Goals-ICISDG’23</p>
        <p className='text-paragraph'>Last Date: Session1:09.04.2023 & Session2:01.05.2023</p>
      </div>
