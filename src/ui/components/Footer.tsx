      ...
      <div className="2xl:px-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className='col-span-2 md:col-span-1'>
            <h3 className="text-sm xl:text-base 2xl:text-2xl font-semibold text-gray-900 uppercase tracking-wider mb-4">
              CONTACT US
            </h3>
            <div className="space-y-1 text-sm xl:text-base 2xl:text-2xl text-gray-600">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm xl:text-base 2xl:text-2xl  text-gray-600">
          ...
          <div className=''>
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-3 py-2 border border-gray-200 bg-white rounded-l-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm xl:text-base 2xl:text-2xl"
              />
              <button
                onClick={handleSubmit}
                className="px-6 py-2 bg-primary text-white rounded-r-md hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 text-sm xl:text-base 2xl:text-2xl font-medium"
              >
                Join
              </button>
            </div>
        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-start space-y-4 lg:space-y-0 relative">
            ...
            <div className="text-center w-fit mx-auto">
              ...
              <p className="text-sm xl:text-base 2xl:text-2xl text-gray-600">
                Work is licensed under a Creative Commons Attribution 4.0 International License.
              </p>
              <div className="mt-2 text-center">
                <div className="flex flex-wrap justify-center space-x-1 text-sm xl:text-base 2xl:text-2xl">
