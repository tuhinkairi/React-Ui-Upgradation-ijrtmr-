  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm leading-relaxed">
        Full Distinguished Professor and Academic Tenure of Chemistry, Enrico Fermi Distinguished Chair in Molecular Spectroscopy, Head of Cancer Research Institute (CRI), Director of the Bio Spectroscopy Core Research Laboratory at Faculty of Chemistry, California South University (CSU), Irvine, President of the American International Standards Institute(AISI), Irvine, California, USA.
      </p>
      <div className="space-y-4">
        <address className="flex items-center not-italic gap-2"><strong>Address : </strong>California, USA</address>
        <h1 className="flex items-center gap-2"><strong>E-Mail : </strong>Alireza.Heidari@calsu.us</h1>
        <h1 className="flex items-center gap-2"><strong>Profile Link:</strong></h1>
        <address className="flex items-center not-italic gap-2"><strong>Country : </strong>United States</address>
      </div>
