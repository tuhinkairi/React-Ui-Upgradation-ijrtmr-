...
const AimScope = () => {
  return (
    <div className="space-y-8 text-base xl:text-xl 2xl:text-2xl">
      {/* Aim Section */}
      <section>
        <Title2>Aim</Title2>
